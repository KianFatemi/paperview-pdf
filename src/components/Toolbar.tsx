...
const Toolbar: React.FC<ToolbarProps> = ({ setPdfData, handleZoomIn, handleZoomOut, handleFitToScreen, onOpenSearch, zoomLevel, stickyNoteMode, onToggleStickyNoteMode }) => {
